          ...
          <div className="max-w-6xl mx-auto flex flex-col items-center">
            ...
            <section className="w-full text-left py-20 animate-fade-up">
              <div className="flex items-center space-x-2 mb-8">
                ...
                <span className="text-emerald-500 text-xs font-bold tracking-[0.2em] uppercase">Explainable Fake Review Detector</span>
              </div>
              ...
              <p className="max-w-xl text-zinc-400 text-xl leading-relaxed mb-12">
                Machine-learning model trained on 20k+ reviews. Detects manipulation patterns, synthetic text, and coordinated fraud in under 10 seconds.
              </p>
